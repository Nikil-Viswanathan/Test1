...
bgcolor = createSprite(windowWidth/2 , windowHeight/2 , windowWidth , windowHeight);
bgcolor.shapeColor = "#00008B"
bgcolor.visible = false;
    bg = createSprite(windowWidth/2,windowHeight/2,windowWidth,windowHeight)
    bg.addImage(bgImg);
    bg.scale = 3.5
    bg2 = createSprite(windowWidth/2  , windowHeight/2, windowWidth-100 ,windowHeight-70 );
    bg2.addImage(bgImg2);
    bg2.scale = 2.5;
    bgfork = createSprite(windowWidth/2 , windowHeight/2, windowWidth - 100 , windowHeight - 70);
    bgfork.addImage(bgforkImg);
    bgfork.visible = false;
   uparrow = createSprite(windowWidth/2 - 400 , windowHeight - 300 , 10 , 10);
   uparrow.addImage(uparrowImg);
   uparrow.scale = 0.2;
   uparrow.visible = false;
   dgarrow = createSprite(windowWidth/2 + 200 , windowHeight - 300, 10 , 10)
  ...
  dgarrow.visible = false;
   ...
   Player2 = createSprite(windowWidth/2 - 400 , windowHeight - 200 , 50 , 50)
    Player2.addAnimation("Player2Img" , Player2Anim);
    Player2.scale = 1.5;
    Enemy1 = createSprite(windowWidth/2 + 70 , windowHeight - 300 ,50,50);
    Enemy1.scale = 2;
    Enemy1.addAnimation("Enemy1Img" , Enemy1Anim );
  
    Enemy1.setCollider("Rectangle" , 0 , 0 , 100 , 100);
Enemy2 = createSprite(windowWidth/2 + 100 , windowHeight - 150 ,50 ,50);
Enemy2.scale = 3;
...
hitboxbutton.position(windowWidth/2, windowHeight - 700);
...
hitboxbuttonoff.position(windowWidth/2, windowHeight - 800);
...
hitButton.position(150 , windowHeight - 150);
...
upButton2.hide();*/
restart = createSprite(windowWidth/2 , windowHeight/2 + 150 , 10 , 10);
...
//rightButton.hide();
//upButton.hide();
nextbutton.position = (windowWidth/2 , windowHeight/2 + 200);
